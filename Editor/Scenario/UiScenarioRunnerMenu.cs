...
namespace UniTestify.Editor
{
    ...
    public static class UiScenarioRunnerMenu
    {
        ...
        private const string SessionStatePathKey = "UniTestify.UiScenarioRunnerMenu.ScenarioPath";
        private const string SessionStateResultPathKey = "UniTestify.UiScenarioRunnerMenu.ResultPath";
